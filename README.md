...
stats 		- geeft statestieken weer over het gegenereerde level.
map 		- geeft een venster weer met daarin een abstrakte weergave van het huidige level.
use nibler 	- dit is een cheat welke je gelijk het gezochte item (Dark Matter, fuel) geeft. 
